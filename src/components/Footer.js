                 ...
                 <div className="col-md-4 col-sm-11 col-xs-11 my-3">
                     <div className="footer-text pull-left">
                          <div className="d-flex">
                              ...
                              <h2 style={{color: 'white'}}>ASME-VIT</h2>
                          </div>
                          <p>
            VIT Vellore<br></br><br></br>
            <strong>Girish Pranav</strong><br></br>
             <strong>Phone:</strong><a href="tel: 9052879117">+91-9052879117</a> <br></br>
             <strong>Email: </strong><a  style={{fontWeight: "normal"}} href="mailto:officialasmevit@gmail.com">officialasmevit@gmail.com</a> <br></br>
           </p>
                 ...
                 <div className="col-md-2 col-sm-4 col-xs-4 my-3" >
                  ...
                  <div className="col col-sm-4 col-xs-4 my-3">
                     ...
                     <h5 className="heading">For sponsorship related queries:</h5>
                     <p> <strong>Aadimithra Anil (Outreach Head, ASME-VIT)
           <br></br>
            Email: </strong><a  style={{fontWeight: "normal"}} href="mailto:aadimithra.anil2020@vitstudent.ac.in">aadimithra.anil2020@vitstudent.ac.in</a> <br></br>
             ...
             <div className="col-md-6 col-sm-6 col-xs-6">
                 ...
                 <div className="pull-left">
                     ...
                     <p><i className="fa fa-copyright"></i> 2020 asmevit.com</p>
