             ...
             <p class="blogItem-desc" style={{textAlign: 'justify', marginTop: '-3px'}}>{description} </p>
              ...
              <div class="blog-info clearfix">
                  ...
                  <div className='blogItem-author'>
                    ...
                    <p style={{fontStyle: 'italic'}}><i class="fa fa-user"></i> {authorName}</p>
              </div>
                  </div>
                  <div class="post-right"> 
                  <ul>
                          <li><Link style={{float: 'right', color: '#a9a9a9'}} to={`/blogs`}><i class="fa fa-calendar"></i> <span>{createdAt}</span></Link></li>
                      </ul>
                  </div>
              </div>
          </div>
